 ...
 * @return the transfer
 */
public Transfer toTransferDO(@Validated @NotNull final TransferDTO transferDTO) {
     ...
     */
    public TransferDTO toTransferDTO(@Validated @NotNull final Transfer transfer) {
